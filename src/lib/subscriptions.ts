...
const PLAN_DISPLAY_CONFIG: Record<OwnerPlan, PlanDisplayConfig> = {
  free: {
    ...PLAN_CONFIG.free,
    features: [
      "Up to 1 property and 8 tenants",
      "Tenant lifecycle management",
      "Basic onboarding, Profile and Billing Details",      
      "Rent collection history, Receipts, and Billing period tracking",     
      "Tenant document upload and review flow for KYC checks",     
    ],
    ctaLabel: "Start Free",
    ctaHref: "/register",
    highlighted: false,
  ...
  starter: {
    ...
    features: [
      "Everything in Free",
      "Up to 1 property and 50 tenants",
      "Full Hostel setup, Occupancy tracking, and Tenant lifecycle workflows",
      "Rent payments, Expenses, Notices, Maintenance, and Profile management in one dashboard",
      "Tenant KYC review, KYC Document uploads, and Approval tracking",
      "Reports and Analytics for occupancy, payments, defaulters,and expenses",
      "Email support for onboarding and day-to-day operations",
      "A strong fit for single-property PGs and hostels scaling up",
    ],
  ...
  micro: {
    ...
    features: [
      "Everything in free",
      "Up to 2 properties and 120 tenants",
      "Full Hostel setup, Occupancy tracking, and Tenant lifecycle workflows",
      "Rent payments, Expenses, Notices, Maintenance, and Profile management in one dashboard",
      "Tenant KYC review, KYC Document uploads, and Approval tracking",
      "Reports and Analytics for occupancy, payments, defaulters,and expenses",
      "Email support for onboarding and day-to-day operations",
      "A strong fit for small to medium-sized PGs and hostels",
    ],
  ...
  pro: {
    ...
    features: [
      "Everything in free",
      "Up to 3 properties and 150 tenants",
      "Full Hostel setup, Occupancy tracking, and Tenant lifecycle workflows",
      "Rent payments, Expenses, Notices, Maintenance, and Profile management in one dashboard",
      "Tenant KYC review, KYC Document uploads, and Approval tracking",
      "Reports and Analytics for occupancy, payments, defaulters,and expenses",
  ...
  institution: {
    ...
    features: [
      ...
      "Dedicated sales-assisted setup, onboarding, and rollout support",
      ...
      "Tenant profile, ID, and KYC workflows for institutional use cases",
      "Separate institution and inmate portal access for large communities",
      "Priority rollout support, tailored reporting, and account management",
      "For established institutions, large PGs and hostel chains"
    ],
