...
const PLAN_DISPLAY_CONFIG: Record<OwnerPlan, PlanDisplayConfig> = {
  free: {
    ...PLAN_CONFIG.free,
    features: [
      "Owner dashboard overview and quick activity snapshots",
      "Tenant and room management with occupancy status",
      "Up to 1 property and 15 tenants",
      "Rent, receipts, and billing history tracking",
      "Subscription visibility and usage insights",
      "Tenant document upload and review flow",
    ],
    ctaLabel: "Start Free",
    ctaHref: "/register",
    highlighted: false,
  ...
  starter: {
    ...PLAN_CONFIG.starter,
    features: [
      "Full access to dashboard, hostels, tenants, payments, and usage",
      "Set up floors, rooms, and occupancy for 1 property",
      "Support for up to 50 tenants with lifecycle workflows",
      "Publish notices and manage maintenance requests",
      "Track expenses and payment statuses in one place",
      "Tenant profile and identity document uploads",
      "Email support for a smooth onboarding experience",
    ],
  ...
  micro: {
    ...PLAN_CONFIG.micro,
    features: [
      "Complete owner portal access across all key modules",
      "Up to 2 properties and 120 tenants",
      "Live occupancy tracking and room assignment tools",
      "Streamlined notices, maintenance, payments, and expenses",
  ...
  pro: {
    ...PLAN_CONFIG.pro,
    features: [
      "All owner modules unlocked for full operational control",
      "Up to 3 properties and 150 tenants",
      "Advanced reports, occupancy analytics, and room-level visibility",
      "Priority flows for notices, maintenance, payments, expenses, and settings",
      "Tenant KYC, profile, and document workflows in one place",
      "Faster support for growing property teams",
    ],
    ctaLabel: "Choose Pro",
    ctaHref: "/register",
    highlighted: false,
